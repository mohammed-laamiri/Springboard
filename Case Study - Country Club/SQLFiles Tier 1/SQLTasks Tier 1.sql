...
ORDER BY f.membercost*b.slots DESC

/* Q9: This time, produce the same result as in Q8, but using a subquery. */

select DISTINCT t.name, t.members_name, t.cost
from
(select f.name, CONCAT( m.firstname, ' ', m.surname ) AS members_name,
...
SELECT m.memid, m.surname, m.firstname, CONCAT(r.firstname,  ' '  ,r.surname) AS recommender
FROM Members AS m
